...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden px-4 sm:px-6 pt-20 pb-32 lg:pt-32 lg:pb-40">
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            <ScrollReveal delay={0.15} duration={0.7}>
            ...
            <ScrollReveal delay={0.3} duration={0.7}>
              <p className="text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                Organize suas transações, controle contas a pagar, acompanhe
                seus gastos e tome decisões financeiras mais assertivas.
              </p>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal delay={0.5} duration={0.7}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <Button
                size="lg"
                className="flex items-center gap-3 group bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 text-lg font-semibold shadow-md shadow-blue-500/25 transform-gpu transition duration-200 hover:scale-105 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-400"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-slate-700 bg-slate-900/60 text-slate-200 hover:bg-slate-800 hover:text-white px-8 py-4 text-lg font-semibold backdrop-blur-sm transition transform-gpu duration-200 hover:scale-105 hover:border-slate-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-slate-600"
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8 text-sm text-slate-300">
            {[
              ...
              <ScrollReveal key={feature} delay={0.7 + index * 0.1}>
      ...
      {/* Scroll hint: bouncing down arrow */}
      <div className="absolute left-1/2 -translate-x-1/2 bottom-8">
        <button
          ...
          className="flex items-center justify-center w-10 h-10 rounded-full text-slate-200 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer dark:text-slate-400 dark:hover:text-white"
        >
